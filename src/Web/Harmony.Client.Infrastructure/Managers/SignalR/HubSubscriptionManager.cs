...
namespace Harmony.Client.Infrastructure.Managers.SignalR
{
    ...
    public class HubSubscriptionManager : IHubSubscriptionManager
    {
        ...
        public event EventHandler<TagPushedMessage> OnTagPushed;
        ...
        private void HandleCardChanges()
        {
            ...
            _hubConnection.On<CardCommentCreatedMessage>(ApplicationConstants.SignalR.OnCardCommentCreated, (@event) =>
            {
                OnCardCommentCreated?.Invoke(this, @event);
            });
            ...
            _hubConnection.On<TagPushedMessage>(ApplicationConstants.SignalR.OnTagPushed, (@event) =>
            {
                OnTagPushed?.Invoke(this, @event);
            });
        }
