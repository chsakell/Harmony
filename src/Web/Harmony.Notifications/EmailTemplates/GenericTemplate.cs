    ...
    public partial class EmailTemplates
    {
            ...
            string buttonText, string buttonLink)
        {
            return GenericTemplate
                ...
                .Replace("{button-link}", buttonLink);
        }

        public const string GenericTemplate = @"<!DOCTYPE html>
...
<v:roundrect xmlns:v=""urn:schemas-microsoft-com:vml"" xmlns:w=""urn:schemas-microsoft-com:office:word"" href=""{button-link}"" style=""height:62px;width:132px;v-text-anchor:middle;"" arcsize=""7%"" stroke=""false"" fillcolor=""#2360b1"">
<w:anchorlock/>
<v:textbox inset=""0px,0px,0px,0px"">
<center style=""color:#ffffff; font-family:'Trebuchet MS', Tahoma, sans-serif; font-size:16px"">
<![endif]--><a href=""{button-link}"" style=""text-decoration:none;display:inline-block;color:#ffffff;background-color:#2360b1;border-radius:4px;width:auto;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:15px;padding-bottom:15px;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;font-size:16px;text-align:center;mso-border-alt:none;word-break:keep-all;"" target=""_blank""><span style=""padding-left:15px;padding-right:15px;font-size:16px;display:inline-block;letter-spacing:normal;""><span style=""word-break: break-word; line-height: 32px;"">{button-text}</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>
</td>
</tr>
</table>
