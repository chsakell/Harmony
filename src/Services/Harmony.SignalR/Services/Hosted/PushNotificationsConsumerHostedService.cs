                                ...
                                using (IServiceScope scope = _serviceProvider.CreateScope())
                                {
                                    ...
                                    switch (notificationType)
                                    {
                                        ...
                                        case NotificationType.BranchCreated:
                                            ...
                                            break;
                                        case NotificationType.BranchCommitsPushed:
                                            {
                                                var message = JsonSerializer
                                                .Deserialize<BranchCommitsPushedMessage>(ea.Body.Span);
                                        ...
                                        case NotificationType.BranchPullRequestCreated:
                                            ...
                                            break;
                                        case NotificationType.TagPushed:
                                            {
                                                var message = JsonSerializer
                                                .Deserialize<TagPushedMessage>(ea.Body.Span);

                                                await hubClientSourceControlNotifierService.TagPushed(message);
                                            }
                                            break;
                                        default:
                                            break;
