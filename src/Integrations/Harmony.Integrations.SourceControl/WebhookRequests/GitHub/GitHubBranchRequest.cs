...
namespace Harmony.Integrations.SourceControl.WebhookRequests.GitHub
{
    ...
    public class GitHubBranchRequest
    {
        ...
        public GithubBranchRepository repository { get; set; }
        public GithubBranchSender sender { get; set; }
    }
    ...
    public class GithubBranchRepository
    {
        ...
        public GitHubBranchOwner owner { get; set; }
    ...
    public class GitHubBranchOwner
    {
    ...
    public class GithubBranchSender
    {
        public string login { get; set; }
        public int id { get; set; }
        public string node_id { get; set; }
